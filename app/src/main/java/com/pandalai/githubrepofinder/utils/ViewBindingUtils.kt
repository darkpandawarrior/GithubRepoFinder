package com.pandalai.githubrepofinder.utils
...
fun <T : ViewBinding> Fragment.viewBinding(viewBindingFactory: (View) -> T) = FragmentViewBinder(this, viewBindingFactory)

class FragmentViewBinder<T : ViewBinding>(val fragment: Fragment, val viewBindingFactory: (View) -> T) :
